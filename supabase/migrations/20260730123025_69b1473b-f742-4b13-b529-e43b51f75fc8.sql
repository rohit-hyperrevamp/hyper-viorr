...
<div class="form-vii-doc">
  ...
  <div class="gov-fields">
    <div>Name of the Establishment : <span class="field-fill">Radiant Guard Services Pvt. Ltd.</span></div>
    ...
    <div class="address-lines field-fill">
      ...
      <div>Village ________ Thana ________ Sub-division ________ Post Office ________ District ________ State ________</div>
    </div>
  </div>

  <div class="nomination-text">I hereby nominate the person/persons mentioned below to receive the amount standing to my credit in the Labour Welfare Fund, in the event of my death before that amount has become payable, or having become payable has not been paid.</div>
  ...
  <div class="stamp-line">Name, designation and stamp of the employer or other<br/>authorised officers of the Establishment.</div>
</div>
'
...
SET rendered_body = replace(
      replace(
        replace(
          replace(
            replace(
              replace(rendered_body,
                'Name of Establishment :', 'Name of the Establishment :'),
              'standing to my credit in the Labour Welfare Fund in the event of my death before the amount has become payable or having become payable has not been paid.',
              'standing to my credit in the Labour Welfare Fund, in the event of my death before that amount has become payable, or having become payable has not been paid.'),
            'Bombay Labour Welfare Fund Act, 1953, and should I acquire', 'Bombay Labour Welfare Fund Act, 1953 and should I acquire'),
          'employed in my establishment after he/she has read', 'employed in my establishment, after he/she has read'),
