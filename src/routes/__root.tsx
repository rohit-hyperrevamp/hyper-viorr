...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hyper Vioarr" },
      { name: "description", content: "Hyper Vioarr — the workforce operations platform by Vioarr × HyperRevamp." },
      { name: "author", content: "Vioarr × HyperRevamp" },
      { property: "og:title", content: "Hyper Vioarr" },
      { property: "og:description", content: "Hyper Vioarr — the workforce operations platform by Vioarr × HyperRevamp." },
