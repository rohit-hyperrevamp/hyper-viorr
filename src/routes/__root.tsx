...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hyper Viorr" },
      { name: "description", content: "Hyper Viorr — the workforce operations platform by Viorr × HyperRevamp." },
      { name: "author", content: "Viorr × HyperRevamp" },
      { property: "og:title", content: "Hyper Viorr" },
      { property: "og:description", content: "Hyper Viorr — the workforce operations platform by Viorr × HyperRevamp." },
